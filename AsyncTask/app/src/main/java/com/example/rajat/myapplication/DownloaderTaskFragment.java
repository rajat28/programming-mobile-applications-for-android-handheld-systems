...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> friendsIds = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		int friendsListSize = friendsIds.size();
		Integer[] friendsIdsArray = new Integer[friendsListSize];
		friendsIds.toArray(friendsIdsArray);
		downloaderTask = new DownloaderTask(friendsIdsArray);
	...
	{
		Integer[] friendsIdsArray;

		public DownloaderTask(Integer[] friendsIdsArray)
		{
			this.friendsIdsArray = friendsIdsArray;
		}

		@Override
		protected String[] doInBackground(Void... params) {

			String[] tweets = downloadTweets(friendsIdsArray);
			return tweets;
