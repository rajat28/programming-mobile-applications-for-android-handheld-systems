...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> feeds = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		int listSize = feeds.size();
		Integer[] feedsArray = new Integer[listSize];
		feeds.toArray(feedsArray);
		downloaderTask = new DownloaderTask(feedsArray);
	...
	public class DownloaderTask extends AsyncTask<Void,Void,String[]>
	{
		...
		public DownloaderTask(Integer[] feedsArray) {
			this.feedsArray = feedsArray;
		}

		@Override
		protected String[] doInBackground(Void... params) {
			tweets = downloadTweets(feedsArray);
			return tweets;
		}
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != (MainActivity.IS_ALIVE)) {
								...
								PendingIntent pendingRestartMainActivityIntent = PendingIntent.getActivity(mContext,0,restartMainActivityIntent,PendingIntent.FLAG_UPDATE_CURRENT);
								...
								Notification.Builder notificationBuilder = new Notification.Builder(mContext)
										...
										.setContentIntent(pendingRestartMainActivityIntent);
